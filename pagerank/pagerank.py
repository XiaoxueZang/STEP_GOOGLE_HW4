...
class SearchFamous:
    ...
    def refresh_scores(self):
        ...
        for person in self.person_score.keys():
            ...
            if self.person_score[person] == next_score:
                # I need to decide the definition of convergence here, to decide to the precision of calculation.
                count_same += 1
...
new = SearchFamous("small_data.txt", 100)
